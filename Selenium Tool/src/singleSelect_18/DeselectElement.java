...
public class DeselectElement 
{
	...
	public static void main(String[] args) throws InterruptedException 
	{
		...
		sel.deselectAll();		// UnsupportedOperationException because we can't deselect from Dropdown 
		sel.deselectByIndex(2);	// UnsupportedOperationException because we can't deselect from Dropdown 
